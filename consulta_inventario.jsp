...
<head>
    ...
    <link rel="stylesheet" href="styleIS.css">
        ...
        /* Estilos para la tabla */
         table {
            border-collapse: collapse; /*colapsa los bordes de la tabla para que no se vea doble*/
            width: 75%; 

        }
        
        .divh {
            max-height: 400px; /* Altura máxima del div que tiene la tabla para que no se exceda y haga overflow*/
