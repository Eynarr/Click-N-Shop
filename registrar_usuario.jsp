...
<header>
    <div class="header">
<a href="Home.html" class="logo"><img src="img/Logo-removebg.png" alt="Logo"></a>        <div class="header-derecha">
...
<body>
    ...
    <% // captura de los valores que vienen desde el formulario.
        ...
        Connection dbconection = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "Eynar", "123");
        Statement state = dbconection.createStatement();
        
        //consulta falta telefono
        String cadena = "INSERT INTO usuariocomprador (id_usuario, nombre_usuario, apellido_usuario, email_usuario, contrasenha_usuario, fecha_nacimiento_usuario, provincia, distrito, corregimiento, calle, numero_casa) VALUES (seq_usuario.NEXTVAL ,'"+nombre+"','"+apellido+"','"+email+"','"+contrasenha+"', TO_DATE('"+fecha+"', 'YYYY-MM-DD'), '"+provincia+"','"+distrito+"','"+corregimiento+"','"+calle+"','"+numerocasa+"')";
       	
        //Ejecutamos la consulta
        state.executeUpdate(cadena);
    %>
